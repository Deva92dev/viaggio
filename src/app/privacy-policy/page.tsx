...
// FIXED: Proper centering for large screens
        ...
        <div className="container mx-auto px-3 sm:px-4 md:px-6 lg:px-8 xl:px-12">
          ...
          <div className="max-w-4xl mx-auto">
            <div className="space-y-12">
              ...
              <section id="information-we-collect" className="animate-fade-in">
                ...
                <div className="bg-white/90 backdrop-blur-xl rounded-2xl border border-white/20 shadow-xl p-6 sm:p-8">
                  <div className="space-y-6">
                    ...
                    <div>
                      ...
                      <p className="text-[hsl(var(--muted-foreground))] leading-relaxed pl-6">
                        Analyze usage patterns to improve our platform, develop
                        new features, and enhance overall user experience.
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="text-[hsl(var(--muted-foreground))] leading-relaxed pl-6">
                        Meet legal obligations, prevent fraud, ensure security,
                        and protect the rights and safety of our users and
                        partners.
                      </p>
                    </div>
                  </div>
                ...
                <div className="bg-white/90 backdrop-blur-xl rounded-2xl border border-white/20 shadow-xl p-6 sm:p-8">
                  <div className="bg-amber-50 border-l-4 border-amber-400 p-4 mb-6 rounded-r-lg">
                    ...
                    <p className="text-amber-700 text-sm">
                      We never sell your personal data to third parties. Sharing
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <p className="text-[hsl(var(--muted-foreground))] text-sm leading-relaxed">
                        Secure payment gateways to process transactions (payment
                        data is encrypted and tokenized).
                      </p>
                    </div>
              ...
              <section id="your-rights" className="animate-fade-in">
                ...
                <div className="bg-white/90 backdrop-blur-xl rounded-2xl border border-white/20 shadow-xl p-6 sm:p-8">
                  <p className="text-[hsl(var(--foreground))] mb-6 leading-relaxed">
                    You have complete control over your personal data. Here are
                    your rights:
                  </p>
