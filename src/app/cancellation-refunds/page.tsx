...
export const metadata: Metadata = {
  ...
  description:
    "Understand Viagio's cancellation and refund policy. Flexible options for changes and cancellations with transparent terms and conditions.",
  keywords: [
    "cancellation policy",
    "refund policy",
...
export default function RefundCancellationPage() {
  ...
  const cancellationSchema = buildWebPage(
    "About Viagio's cancellation and refunds policy",
    `${BASE_URL}/about`,
    "How we cancel and refunds things at Viaggio"
  );
                ...
                <section id="general-policy" className="animate-fade-in">
                  ...
                  <div className="bg-white/90 backdrop-blur-xl rounded-2xl border border-white/20 shadow-xl p-6 sm:p-8 mb-6">
                    <p className="text-[hsl(var(--foreground))] mb-6 leading-relaxed">
                      Our refund policy is designed to be fair and flexible
                      while protecting both travelers and service providers.
                      Refund amounts and processing times depend on when you
                      cancel relative to your travel date.
                    </p>
                  ...
                  <div className="bg-white/90 backdrop-blur-xl rounded-2xl border border-white/20 shadow-xl p-6 sm:p-8">
                    <div className="space-y-6">
                      ...
                      <div>
                        ...
                        <p className="text-[hsl(var(--muted-foreground))] text-sm leading-relaxed pl-6">
                          ...
                          institution. Bank transfers may take longer than
                          credit card refunds during peak periods.
                        </p>
                      </div>
                      <div>
                        <h3 className="font-semibold text-[hsl(var(--foreground))] mb-3 flex items-center gap-2">
                        ...
                        <p className="text-[hsl(var(--muted-foreground))] text-sm leading-relaxed pl-6">
                          You will receive email confirmation when your refund
                          is processed, including transaction details and
                          expected arrival timeframes.
                        </p>
                      </div>
                      <div>
                        <h3 className="font-semibold text-[hsl(var(--foreground))] mb-3 flex items-center gap-2">
                    ...
                    <div className="bg-green-50 border-l-4 border-green-500 p-4 mt-6 rounded-r-lg">
                      ...
                      <p className="text-green-700 text-sm">
                        We guarantee all approved refunds will be processed
                        within the stated timeframe. If you don not receive your
                        refund on time, contact us for immediate assistance.
                      </p>
                    </div>
                  </div>
                </section>
