        ...
        <div className="container mx-auto px-3 sm:px-4 md:px-6 lg:px-8 xl:px-12">
          <div className="text-center mb-12">
            ...
            <p className="text-[hsl(var(--muted-foreground))] max-w-2xl mx-auto">
              Our commitment to hassle-free booking and flexible travel planning
            </p>
          </div>
        ...
        <div className="container mx-auto px-3 sm:px-4 md:px-6 lg:px-8 xl:px-12">
          <div className="max-w-4xl mx-auto">
            <div className="space-y-12">
                  ...
                  <div className="space-y-6">
                    ...
                    <div>
                      ...
                      <p className="text-[hsl(var(--muted-foreground))] leading-relaxed pl-6">
                        ...
                        departure with final details and any important updates.
                      </p>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="space-y-6">
                    <div>
                      ...
                      <p className="text-[hsl(var(--muted-foreground))] text-sm leading-relaxed">
                        ...
                        pandemics, or other force majeure events, we offer full
                        refunds or free rebooking for affected travelers.
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="text-[hsl(var(--muted-foreground))] text-sm leading-relaxed">
                        ...
                        emergencies (with medical certificate) are eligible for
                        full refund or credit for future travel.
                      </p>
                    </div>
              ...
              {/* Contact Information */}
              <section id="contact-booking-support" className="animate-fade-in">
                <div className="flex items-center mb-6">
                  <div className="w-8 h-8 bg-gradient-to-br from-[hsl(var(--primary))] to-[hsl(var(--accent))] rounded-lg flex items-center justify-center mr-3 shadow-lg">
                ...
                <div className="bg-white/90 backdrop-blur-xl rounded-2xl border border-white/20 shadow-xl p-6 sm:p-8">
                  <p className="text-[hsl(var(--foreground))] mb-6 leading-relaxed">
                    Need help with your booking or have questions? Our dedicated
                    booking team is here to assist you.
                  </p>
