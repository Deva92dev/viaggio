                ...
                <div className="bg-white/90 backdrop-blur-xl rounded-2xl border border-white/20 shadow-xl p-6 sm:p-8">
                  ...
                  <div className="bg-blue-50 border-l-4 border-[hsl(var(--primary))] p-4 rounded-r-lg">
                    <div className="flex items-center gap-2 mb-2">
                      <Gavel size={16} className="text-[hsl(var(--primary))]" />
              ...
              <section id="services" className="animate-fade-in">
                ...
                <div className="bg-white/90 backdrop-blur-xl rounded-2xl border border-white/20 shadow-xl p-6 sm:p-8">
                  <p className="text-[hsl(var(--foreground))] mb-6 leading-relaxed">
                    Viagio provides comprehensive travel services including but
                    not limited to:
                  </p>
                  ...
                  <div className="space-y-6">
                    ...
                    <div>
                      ...
                      <p className="text-[hsl(var(--muted-foreground))] text-sm leading-relaxed mb-3">
                        ...
                        information when making bookings or using our services.
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="text-[hsl(var(--muted-foreground))] text-sm leading-relaxed">
                        ...
                        bookings and acknowledge that prices may change based on
                        availability.
                      </p>
                    </div>
                  </div>
                ...
                <div className="bg-white/90 backdrop-blur-xl rounded-2xl border border-white/20 shadow-xl p-6 sm:p-8">
                  ...
                  <div className="bg-amber-50 border-l-4 border-amber-400 p-4 mt-6 rounded-r-lg">
                    ...
                    <p className="text-amber-700 text-sm">
                      ...
                      account suspension, booking cancellation, and legal action
                      where applicable.
                    </p>
                  </div>
                </div>
                  ...
                  <div className="space-y-6">
                    ...
                    <div>
                      ...
                      <p className="text-[hsl(var(--muted-foreground))] text-sm leading-relaxed pl-6">
                        ...
                        specified. Applicable taxes and fees are included in the
                        final price.
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="text-[hsl(var(--muted-foreground))] text-sm leading-relaxed pl-6">
                        Payment disputes must be reported within 60 days of the
                        transaction. We work with customers to resolve payment
                        issues fairly.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="space-y-6">
                    <div>
                      ...
                      <p className="text-[hsl(var(--muted-foreground))] text-sm leading-relaxed">
                        ...
                        with the laws of [Jurisdiction], without regard to
                    ...
                    <div>
                      ...
                      <p className="text-[hsl(var(--muted-foreground))] text-sm leading-relaxed">
                        ...
                        communication. If resolution cannot be reached, disputes
                    ...
                    <div>
                      ...
                      <p className="text-[hsl(var(--muted-foreground))] text-sm leading-relaxed">
                        ...
                        appropriate courts of [Jurisdiction], and you consent to
