        ...
        <div className="absolute inset-0 flex items-center z-20 pt-16 sm:pt-20 md:pt-24 lg:pt-16">
          <div className="container mx-auto px-3 sm:px-4 md:px-6 lg:px-8 xl:px-12">
            <div className="max-w-4xl w-full">
              ...
              >
                Connecting travelers with extraordinary experiences since 2016.
                We are passionate about creating unforgettable journeys that
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
            {stats.map((stat, index) => (
              ...
              >
                ...
                <h3 className="text-2xl sm:text-3xl font-black bg-gradient-to-r from-[hsl(var(--primary))] to-[hsl(var(--accent))] bg-clip-text text-transparent">
                  {stat.value}
                </h3>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <div className="animate-fade-in">
              ...
              <div className="space-y-4 sm:space-y-6">
                ...
                <p className="text-[hsl(var(--foreground))] text-base sm:text-lg leading-relaxed">
                  Founded in 2016 by a team of passionate travelers, we started
                  with a mission to make extraordinary travel experiences
                  accessible to everyone. Today, we have helped over 50,000
                  travelers discover the world in ways they never imagined.
                </p>
                <p className="text-[hsl(var(--foreground))] text-base sm:text-lg leading-relaxed">
                  From hidden local gems to iconic world destinations, we curate
                  each experience with care, ensuring every journey is as unique
                  as the traveler embarking on it.
                </p>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
            {team.map((member, index) => (
              ...
              >
                ...
                <h3 className="text-xl sm:text-2xl font-bold text-[hsl(var(--foreground))] mb-2">
                  {member.name}
                </h3>
                <p className="text-[hsl(var(--accent))] font-semibold mb-2 sm:mb-3">
                  {member.role}
                </p>
