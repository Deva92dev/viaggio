...
export default function Hero() {
  return (
    ...
    >
      <div className="relative z-10 max-w-3xl mx-auto px-4 pt-28 pb-16 text-center md:text-right md:ml-auto md:mr-16 font-inter">
        <p className="text-lg font-normal tracking-widest uppercase text-orange-400">
          Discover the world
        </p>

        <h1 className="mt-4 text-2xl sm:text-3xl md:text-5xl lg:text-7xl font-bold leading-tight text-white font-poppins">
          Welcome to <br />
          <span className="text-orange-400">Viaggio</span>
        </h1>

        <h2 className="mt-6 text-base sm:text-lg text-gray-200 max-w-xl md:ml-auto leading-[1.4] font-normal">
