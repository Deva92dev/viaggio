  ...
  return (
    ...
    >
      ...
      <div
        ...
        aria-hidden="true"
      >
        <div className="absolute top-16 right-20 w-72 h-72 rounded-full bg-[hsl(var(--primary))] blur-3xl opacity-10 motion-safe:animate-pulse" />
        <div
          className="absolute bottom-16 left-20 w-80 h-80 rounded-full bg-[hsl(var(--accent))] blur-3xl opacity-15 motion-safe:animate-pulse"
